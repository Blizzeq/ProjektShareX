...
import addfile from "../../Assets/Home/DocumentPlus.svg";
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <button onClick={() => handleDeleteProject(activeProject.id)}
                                            id={'delete-button-project'}>
                                        <img src={`${activeProject.id === item.id ? TrashRed : Trash}`}
                                             alt={'Delete project'}
                                             className={'w-6'}/>
                                    </button>
                                    <button onClick={() => openProjectUsersModal()} id={'delete-button-project'}>
                                        <img src={`${activeProject.id === item.id ? addusergreen : adduser}`}
                                             alt={'adduser'}
                                             className={'w-6'}/>
                                    </button>
                                </div>
                                                    ...
                                                    {Object.entries(activeProject.tasks.reduce((tasksByStatus, task) => {
                                                        ...
                                                        <div key={statusName} className={'task-column'}>
                                                            ...
                                                            <div className={'tasks'}>
                                                                                    ...
                                                                                    <>
                                                                                        ...
                                                                                        <ul>
                                                                                            {assignedUsersByTask[task.id].map((username) => (
                                                                                                <li key={username}
                                                                                                    id={'assigned-users-container'}>
                                                                                                    {username}
                                                                                                    <button
                                                                                                        onClick={(e) => {
                                                                                                            e.stopPropagation();
                                                                                                            handleDeleteAssignedUserToTask(username, task.id)
                                                                                                        }}><img
                                                                                                        src={deletetaskred}
                                                                                                        alt={'Delete user'}
                                                                                                        className={'w-6'}/>
                                                                ...
                                                                <button onClick={() => openModal(statusName)}
                                                                        id={'add-button'}>
                                                            ...
                                                            <div className={'status-edit-container'}>
                                                                <button
                                                                    onClick={() => openDeleteStatusConfirmation(statusName)}
                                                                    id={'delete-button'}>
